...
from fishbase.fish_data import cardbin_check_bankcard, idcard_check_number
...
class TestFishRandom(object):
    ...
    def test_gen_bank_card_01(self):
        ...
        assert cardbin_check_bankcard(random_bank_card)
    ...
    def test_gen_id_01(self):
        ...
        # 测试身份证是否合法
        check_valid_list = list(map(idcard_check_number, random_id_list_3))

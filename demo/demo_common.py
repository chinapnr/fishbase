...
if __name__ == '__main__':
    ...
    # 定义需要判断的列表
    #合法列表
    test_list_legitimate = ['Hello World', 1]
    #非法列表
    test_list_illegal = ['Hello World', None]


    # 判断列表是否有非法参数
    result = if_any_elements_is_space(test_list_legitimate)
    print(result)
    result = if_any_elements_is_space(test_list_illegal)
    print(result)
